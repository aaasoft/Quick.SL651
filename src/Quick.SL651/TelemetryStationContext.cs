    ...
    public class TelemetryStationContext
    {
        ...
        private async Task beginReadData()
        {
            ...
            try
            {
                ...
                //读取帧头
                var messageFrameHead = new MessageFrameInfo(WorkMode, true);
                bufferStartIndex = await messageFrameHead.ReadHead(
                    stream,
                    read_buffer,
                    bufferStartIndex,
                    cancellationToken,
                ...
                //读取帧尾
                bufferStartIndex = await messageFrameHead.ReadTail(
                    stream,
                    read_buffer,
                    bufferStartIndex,
                    cancellationToken,
                ...
                if (messageFrameHead.IsEndMarkETX
